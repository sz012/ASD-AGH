'''
Szymon Pytel
Kod ma zadzialac tak aby ustawic w rzedach studentow zgodnie z warunkami zadania
Oznacza to ze zaden student w rzedzie x nie moze byc nizszy od najwyzszego studenta w rzedzie x - 1
Co wiecej kazdy wyzszy rzad ma o jednego studenta wiecej
Na wejsciu dostajemy tablice studentow z ich numerami indeksow oraz wzrostem, m oznacza ilosc rzedow
a k ilosc studentow w najnizszym rzedzie
'''
